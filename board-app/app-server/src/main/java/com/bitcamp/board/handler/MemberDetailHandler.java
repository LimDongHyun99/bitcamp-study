...
public class MemberDetailHandler implements Servlet {
  ...
  public void service(Map<String, String> paramMap, PrintWriter out) throws Exception {
    ...
    if (member == null) {
      ...
      out.println("  <tr>");
      out.printf("    <th>번호</th><td><input name='no' type='number' value='%d' readonly></td>",
          member.no);
      out.println("  </tr>");
      out.println("  <tr>");
      out.printf("    <th>이름</th><td><input name='name' type='text' value='%s' size='60'></td>",
          member.name);
      out.println("  </tr>");
      out.println("  <tr>");
      out.printf("    <th>이메일</th><td><input name='email' type='email' value='%s' size='60'></td>",
          member.email);
      out.println("  </tr>");
      out.println("  <tr>");
